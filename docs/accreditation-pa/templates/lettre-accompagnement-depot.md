# Modèle — lettre d’accompagnement (dépôt immatriculation PA)

> À adapter sur en-tête DanielCraft avant envoi via la démarche en ligne ou courrier.
...
- la synthèse exécutive et l’architecture technique ;
- la description des mesures de sécurité et de protection des données personnelles ;
- le certificat **ISO/IEC 27001** (ou attestation en cours selon stade) ;
- les éléments relatifs à l’hébergement en Union européenne.

Je reste à votre disposition pour tout complément d’information et pour la réalisation des **tests d’interopérabilité** avec le Portail Public de Facturation et les autres plateformes agréées.

Veuillez agréer, Madame, Monsieur, l’expression de ma considération distinguée.

**Loïc DANIEL**  
DanielCraft  
contact@danielcraft.fr — 03 87 78 09 16  
57000 Metz

---

_Pièces jointes : voir checklist [07-checklist-depot-immatriculation.md](../07-checklist-depot-immatriculation.md)_
