...
export const PRODUCT_ICON_OPTIONS: ProductIconOption[] = [
  ...
  { name: 'robot', label: 'Agent IA', icon: faRobot },
  { name: 'gauge-high', label: 'Performance', icon: faGaugeHigh },
  { name: 'comments', label: 'Chat', icon: faComments },
  { name: 'chart-pie', label: 'BI / KPI', icon: faChartPie },
  { name: 'file-invoice', label: 'Facturation', icon: faFileInvoice },
  { name: 'arrows-rotate', label: 'Sync', icon: faArrowsRotate },
  { name: 'satellite-dish', label: 'Monitoring', icon: faSatelliteDish },
  { name: 'envelope-open-text', label: 'Campagne email', icon: faEnvelopeOpenText },
  { name: 'calendar-check', label: 'Rendez-vous', icon: faCalendarCheck },
  { name: 'wand-magic-sparkles', label: 'Automatisation IA', icon: faWandMagicSparkles },
